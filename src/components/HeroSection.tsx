    ...
    <div className="relative w-full max-w-[420px]">
      ...
      >
        ...
        <div className="px-6 pb-5">
          <div className="flex items-center justify-between mb-1.5">
            <span className="text-[10px] text-white/20">{t("hero.readerProgress")}</span>
      ...
      >
        <div className="flex items-center gap-2 mb-2.5">
          ...
          <span className="text-[12px] font-semibold text-foreground">{t("hero.aiAssistant")}</span>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          <motion.div variants={stagger} initial="hidden" animate="visible">
            ...
            <motion.div variants={item} className="flex flex-col sm:flex-row gap-3 mb-10">
              ...
              >
                {t("hero.findBook")} <ArrowRight size={18} />
              </Link>
              <a
                href="#features"
            ...
            <motion.div variants={item} className="flex items-center gap-3">
              ...
              <p className="text-sm text-white/35">
                <span className="text-white/60 font-medium">{t("hero.readersCount")}</span>{" "}
                {t("hero.readersPrefix")}
              </p>
            </motion.div>
          </motion.div>
