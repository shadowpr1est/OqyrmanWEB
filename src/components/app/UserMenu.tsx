...
export const UserMenu = () => {
  ...
  const menuItems = [
    { icon: IconUser, label: t("nav.profile"), to: "/profile" },
    { icon: IconBookmark, label: t("nav.myBookings"), to: "/reservations" },
  ];
      ...
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <button className="flex items-center gap-2 px-2 py-2 rounded-xl hover:bg-muted/60 transition-colors outline-none min-h-[44px]">
            ...
            <IconChevronDown size={14} className="text-muted-foreground transition-transform duration-200" />
          </button>
        </DropdownMenuTrigger>
